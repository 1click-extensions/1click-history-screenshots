...
.please-rate-title{
	...
	<div class="please-rate-title">What do you think about this extension?</div>
		...
		<div class="please-rate-text">
			...
			If you like 1Click History with thumbnails <br/><a target=_blank href="https://chrome.google.com/webstore/detail/aaeiploobnfomicfnoloiejlcnagjapl/reviews" >please give us 5-stars</a>
			<br/>
			<div class="addition">
				In addition, If you want to report a bug, or you have a recommendation, please <a href="https://github.com/1click-extensions/1click-history-screenshots/issues/new">report a public issue</a> or  <a href="mailto:1click-history-screenshots@1ce.org">Contact us</a>
			</div>
			<div class="skip-wrp"><button type="button" class="btn-popup no-thanks ">Skip</button></div>
		</div>
		<a class="please-rate-github" href="https://github.com/1click-extensions/1click-history-screenshots">Fork on github</a>
	</div>
	`)
}
